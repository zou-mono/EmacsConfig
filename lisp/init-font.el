...
(defun qiang-set-font (english-fonts
  ...
  (setq chinese-fonts-scale (or chinese-fonts-scale 1.3))
  (save-excursion
    (with-current-buffer (find-file-noselect "~/.config/system-config/emacs-font-size")
      ...
      (save-buffer)
      (kill-buffer)))
  ;; (setq face-font-rescale-alist `(("SimHei" . ,chinese-fonts-scale)
...
(defvar bhj-chinese-fonts '("SimHei" "WenQuanYi Micro Hei" "Fangsong" "NSimSum" "KaiTi"))
...
(cond
 ...
 (t ;; is a linux:-)
  (setq chinese-font-size-scale-alist '((12.5 . 1.25) (14 . 1.25) (16 . 1.3) (20 . 1.3)))))
